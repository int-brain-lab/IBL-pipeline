...
if __name__ == "__main__":
    key = {
        "subject_uuid": UUID("f6fe3981-8b66-4ff7-828b-1a79bd31f0fe"),
    ...
    logger.log(
        30,
        "Ingestion time of ProbeInsertion {}".format(
    ...
    logger.log(
        30,
        "Ingestion time of ProbeTrajectory {}".format(
    ...
    logger.log(
        30,
        "Ingestion time of ChannelGroup {}".format(
    ...
    logger.log(
        30, "Ingestion time of Cluster {}".format(cluster_time - channel_group_time)
    )
    ...
    logger.log(
        30, "Ingestion time of TrialSpikes {}".format(trial_spikes_time - cluster_time)
    )
    ...
    logger.log(
        30,
        "Ingestion time of Raster {}".format(raster_plotting_time - trial_spikes_time),
    )
    ...
    logger.log(
        30,
        "Ingestion time of TrialSpikes {}".format(
            psth_plotting_time - raster_plotting_time
        ),
    )

    end_time = time.time()
    logger.log(30, "Total ingestion time {}".format(end_time - start_time))
