CREATE TABLE `test_ibl_histology`.`#provenance` (
...
CREATE TABLE `test_ibl_histology`.`_probe_trajectory` (
  ...
  CONSTRAINT `_probe_trajectory_ibfk_1` FOREIGN KEY (`subject_uuid`, `session_start_time`, `probe_idx`) REFERENCES `test_ibl_ephys`.`_probe_insertion` (`subject_uuid`, `session_start_time`, `probe_idx`) ON UPDATE CASCADE,
  CONSTRAINT `_probe_trajectory_ibfk_2` FOREIGN KEY (`coordinate_system_name`) REFERENCES `test_ibl_reference`.`#coordinate_system` (`coordinate_system_name`) ON UPDATE CASCADE
...
CREATE TABLE `test_ibl_histology`.`_channel_brain_location` (
  `subject_uuid` binary(16) NOT NULL COMMENT ':uuid:',
  `session_start_time` datetime NOT NULL COMMENT 'start time',
  `probe_idx` int(11) NOT NULL COMMENT 'probe insertion number (0 corresponds to probe00, 1 corresponds to probe01)',
  ...
  CONSTRAINT `_channel_brain_location_ibfk_1` FOREIGN KEY (`subject_uuid`, `session_start_time`, `probe_idx`) REFERENCES `test_ibl_histology`.`_probe_trajectory` (`subject_uuid`, `session_start_time`, `probe_idx`) ON UPDATE CASCADE,
  CONSTRAINT `_channel_brain_location_ibfk_2` FOREIGN KEY (`ontology`, `acronym`) REFERENCES `test_ibl_reference`.`#brain_region` (`ontology`, `acronym`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


CREATE TABLE `test_ibl_histology`.`_cluster_brain_region` (
  `subject_uuid` binary(16) NOT NULL COMMENT ':uuid:',
  `session_start_time` datetime NOT NULL COMMENT 'start time',
  `probe_idx` int(11) NOT NULL COMMENT 'probe insertion number (0 corresponds to probe00, 1 corresponds to probe01)',
  ...
  KEY `ontology` (`ontology`,`acronym`),
  CONSTRAINT `_cluster_brain_region_ibfk_1` FOREIGN KEY (`subject_uuid`, `session_start_time`, `probe_idx`, `cluster_id`) REFERENCES `test_ibl_ephys`.`_default_cluster` (`subject_uuid`, `session_start_time`, `probe_idx`, `cluster_id`) ON UPDATE CASCADE,
  CONSTRAINT `_cluster_brain_region_ibfk_2` FOREIGN KEY (`subject_uuid`, `session_start_time`, `probe_idx`) REFERENCES `test_ibl_histology`.`_probe_trajectory` (`subject_uuid`, `session_start_time`, `probe_idx`) ON UPDATE CASCADE,
  CONSTRAINT `_cluster_brain_region_temp_ibfk_3` FOREIGN KEY (`ontology`, `acronym`) REFERENCES `test_ibl_reference`.`#brain_region` (`ontology`, `acronym`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Brain region assignment to each cluster';



CREATE TABLE `test_ibl_histology`.`__probe_brain_region` (
  `subject_uuid` binary(16) NOT NULL COMMENT ':uuid:',
  `session_start_time` datetime NOT NULL COMMENT 'start time',
  `probe_idx` int(11) NOT NULL COMMENT 'probe insertion number (0 corresponds to probe00, 1 corresponds to probe01)',
  `ontology` varchar(32) NOT NULL,
 `acronym` varchar(32) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL,
  ...
  KEY `ontology` (`ontology`,`acronym`),
  CONSTRAINT `__probe_brain_region_ibfk_1` FOREIGN KEY (`subject_uuid`, `session_start_time`, `probe_idx`) REFERENCES `test_ibl_histology`.`_probe_trajectory` (`subject_uuid`, `session_start_time`, `probe_idx`) ON UPDATE CASCADE,
  CONSTRAINT `__probe_brain_region_ibfk_2` FOREIGN KEY (`ontology`, `acronym`) REFERENCES  `test_ibl_reference`.`#brain_region` (`ontology`, `acronym`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Brain regions assignment to each probe insertion';


CREATE TABLE `test_ibl_histology`.`__depth_brain_region` (
  `subject_uuid` binary(16) NOT NULL COMMENT ':uuid:',
  `session_start_time` datetime NOT NULL COMMENT 'start time',
  `probe_idx` int(11) NOT NULL COMMENT 'probe insertion number (0 corresponds to probe00, 1 corresponds to probe01)',
  ...
  PRIMARY KEY (`subject_uuid`,`session_start_time`,`probe_idx`),
  CONSTRAINT `__depth_brain_region_ibfk_1` FOREIGN KEY (`subject_uuid`, `session_start_time`, `probe_idx`) REFERENCES `test_ibl_histology`.`_probe_trajectory` (`subject_uuid`, `session_start_time`, `probe_idx`) ON UPDATE CASCADE
